...
static void test_pthread_attr_setdetachstate(void) {
  ...
  int detachstate = -1;
  TEST_ASSERT_EQUAL_MESSAGE(0, pthread_attr_getdetachstate(&attr, &detachstate),
  ...
  TEST_ASSERT_EQUAL_MESSAGE(0, pthread_attr_getdetachstate(&attr, &detachstate),
                            "pthread_attr_getdetachstate() should succeed");
  TEST_ASSERT_EQUAL_MESSAGE(PTHREAD_CREATE_JOINABLE, detachstate,
                            "detachstate should not be changed");

  TEST_ASSERT_EQUAL_MESSAGE(
      0, pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_DETACHED),
      "pthread_attr_setdetachstate() should succeed "
      "(w/PTHREAD_CREATE_DETACHED)");
  detachstate = -1;
  TEST_ASSERT_EQUAL_MESSAGE(0, pthread_attr_getdetachstate(&attr, &detachstate),
                            "pthread_attr_getdetachstate() should succeed");
  TEST_ASSERT_EQUAL_MESSAGE(
...
static void test_pthread_attr_setschedpolicy(void) {
  ...
  int policy = -1;
  TEST_ASSERT_EQUAL_MESSAGE(0, pthread_attr_getschedpolicy(&attr, &policy),
                            "pthread_attr_getschedpolicy() should succeed");
  TEST_ASSERT_EQUAL_MESSAGE(SCHED_RR, policy,
  ...
  TEST_ASSERT_EQUAL_MESSAGE(0, pthread_attr_getschedpolicy(&attr, &policy),
                            "pthread_attr_getschedpolicy() should succeed");
  TEST_ASSERT_EQUAL_MESSAGE(SCHED_FIFO, policy,
...
static void test_pthread_attr_setschedparam(void) {
  ...
  TEST_ASSERT_EQUAL_MESSAGE(0, pthread_attr_getschedparam(&attr, &param),
                            "pthread_attr_getschedparam() should succeed");
  TEST_ASSERT_EQUAL_MESSAGE(10, param.sched_priority,
  ...
  TEST_ASSERT_NOT_EQUAL_MESSAGE(-1, max_rr,
                                "sched_get_priority_max() should succeed");
  TEST_ASSERT_NOT_EQUAL_MESSAGE(-1, min_rr,
  ...
  TEST_ASSERT_TRUE_MESSAGE(max_rr >= min_rr,
                           "The value of higher priority should be equal of "
                           "larger than that of lower one");

  memset(&param, 0x55, sizeof(param));
  param.sched_priority = min_rr - 1;
  TEST_ASSERT_EQUAL_MESSAGE(EINVAL, pthread_attr_setschedparam(&attr, &param),
                            "pthread_attr_setschedparam() should fail (w/lower "
                            "out-of-range priority)");
  param.sched_priority = max_rr + 1;
  TEST_ASSERT_EQUAL_MESSAGE(EINVAL, pthread_attr_setschedparam(&attr, &param),
                            "pthread_attr_setschedparam() should fail "
                            "(w/higher out-of-range priority)");
...
static void test_pthread_attr_setstack(void) {
  ...
  TEST_ASSERT_EQUAL_PTR_MESSAGE(NULL, stackaddr,
  ...
  TEST_ASSERT_EQUAL_MESSAGE(
      EINVAL,
      pthread_attr_setstack(&attr, (void *)1,
                            PTHREAD_STACK_MIN + PTHREAD_STACK_MIN - 1),
      "pthread_attr_setstack() should fail (w/unaligned top-of-stack)");
  TEST_ASSERT_EQUAL_MESSAGE(
      EINVAL,
      pthread_attr_setstack(&attr, (void *)PTHREAD_STACK_ALIGN,
                            PTHREAD_STACK_MIN + 1),
      "pthread_attr_setstack() should fail (w/unaligned bottom-of-stack)");
  TEST_ASSERT_EQUAL_MESSAGE(
      EINVAL,
      pthread_attr_setstack(&attr, (void *)PTHREAD_STACK_ALIGN,
                            PTHREAD_STACK_MIN - PTHREAD_STACK_ALIGN),
  ...
  TEST_ASSERT_EQUAL_MESSAGE(PTHREAD_STACK_MIN, stacksize,
  ...
  TEST_ASSERT_EQUAL_MESSAGE(
      0, pthread_attr_getstack(&attr, &stackaddr, &stacksize),
      "pthread_attr_getstack() should succeed");
  TEST_ASSERT_EQUAL_PTR_MESSAGE((void *)PTHREAD_STACK_ALIGN, stackaddr,
                                "stackaddr should be changed");
  TEST_ASSERT_EQUAL_MESSAGE(PTHREAD_STACK_MIN + PTHREAD_STACK_ALIGN, stacksize,
...
static void test_pthread_attr_setstacksize(void) {
  ...
  size_t stacksize = 0xcafebabe;
  TEST_ASSERT_EQUAL_MESSAGE(0, pthread_attr_getstacksize(&attr, &stacksize),
  ...
  TEST_ASSERT_EQUAL_MESSAGE(
      EINVAL, pthread_attr_setstacksize(&attr, PTHREAD_STACK_MIN - 1),
  ...
  TEST_ASSERT_EQUAL_PTR_MESSAGE((void *)PTHREAD_STACK_ALIGN, stackaddr,
                                "stackaddr should not be changed");
  TEST_ASSERT_EQUAL_MESSAGE(PTHREAD_STACK_MIN * 2, stacksize,
                            "stacksize should not be changed");

  TEST_ASSERT_EQUAL_MESSAGE(
      0,
      pthread_attr_setstacksize(&attr,
                                PTHREAD_STACK_MIN + PTHREAD_STACK_ALIGN - 1),
...
static void test_pthread_attr_destroy(void) {
  ...
  TEST_ASSERT_EQUAL_MESSAGE(0, pthread_attr_destroy(&attr),
